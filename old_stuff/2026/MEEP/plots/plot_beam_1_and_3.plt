...
"beam_3.dat" index 0 using ($2*180/3.14):(-$3*180/3.14) w p pt 8 lc -1 lw 1.5  title "Beam 3, 3.60 GHz", \
"beam_3.dat" index 0 using ($2*180/3.14):(-1.5*$5*180/3.14+72.5) w l lc -1 lw 1.5 notitle, \
"beam_3.dat" index 1 using ($2*180/3.14):(-$3*180/3.14) w p pt 9 lc -1 lw 1.5 title "Beam 3, 7.20 GHz", \
"beam_3.dat" index 1 using ($2*180/3.14):(-$5*180/3.14+30) w l lc -1 lw 1.5 notitle, \
"beam_3.dat" index 2 using ($2*180/3.14):(-$3*180/3.14) w p pt 10 lc -1 lw 1.5 title "Beam 3, 10.8 GHz", \
"beam_3.dat" index 2 using ($2*180/3.14):(-$5*180/3.14+20) w l lc -1 lw 1.5 notitle
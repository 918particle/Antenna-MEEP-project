...
frequencies = np.array([constants.frequency_1,constants.frequency_2])
...
#theory_results = radiation_pattern.calculate_theoretical_radiation_pattern(0.0,1*constants.frequency_1)
